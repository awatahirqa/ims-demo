...
create table if not exists ims.orders(OrderID int primary key auto_increment, CustomerID int);
create table if not exists ims.orderline(id int primary key auto_increment, OrderID int,ItemIDs int Quantity int);